<?php 
	...
	class DbOperations{
		...
		public function getCourses($available){
			$courses = array();
			$stmt = $this->con->prepare("SELECT course_id, prerequisite_id, course_name, course_description, capacity FROM course WHERE available = ?");
